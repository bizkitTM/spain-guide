...
export default function MadridLateNight() {
  const options = [
    ...
    },
    {
      ...
      imgUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Amorino_Gelato_Flowers_and_Macaroons.jpg/960px-Amorino_Gelato_Flowers_and_Macaroons.jpg",
